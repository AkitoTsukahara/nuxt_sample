        ...
        <div class="widget-content">
          ...
          <div class="single-blog-post post-style-2 d-flex align-items-center widget-post">
            ...
            <div class="post-thumbnail">
              <img src="~assets/images/blog-img/b11.jpg" alt="">
            </div>
            <!-- Post Content -->
          ...
          <div class="single-blog-post post-style-2 d-flex align-items-center widget-post">
            <!-- Post Thumbnail -->
            <div class="post-thumbnail">
              <img src="~assets/images/blog-img/b13.jpg" alt="">
            </div>
            <!-- Post Content -->
            <div class="post-content">
              <a href="#" class="headline">
          ...
          <div class="single-blog-post post-style-2 d-flex align-items-center widget-post">
            <!-- Post Thumbnail -->
            <div class="post-thumbnail">
              <img src="~assets/images/blog-img/b14.jpg" alt="">
            </div>
            <!-- Post Content -->
            <div class="post-content">
              <a href="#" class="headline">
          ...
          <div class="single-blog-post post-style-2 d-flex align-items-center widget-post">
            <!-- Post Thumbnail -->
            <div class="post-thumbnail">
              <img src="~assets/images/blog-img/b10.jpg" alt="">
            </div>
            <!-- Post Content -->
            <div class="post-content">
              <a href="#" class="headline">
          ...
          <div class="single-blog-post post-style-2 d-flex align-items-center widget-post">
            <!-- Post Thumbnail -->
            <div class="post-thumbnail">
              <img src="~assets/images/blog-img/b12.jpg" alt="">
            </div>
            <!-- Post Content -->
            <div class="post-content">
              <a href="#" class="headline">
      ...
      <div class="sidebar-widget-area">
        ...
        <div class="widget-content">
          ...
          <div class="single-blog-post todays-pick">
            <!-- Post Thumbnail -->
            <div class="post-thumbnail">
              <img src="~assets/images/blog-img/b22.jpg" alt="">
            </div>
            <!-- Post Content -->
